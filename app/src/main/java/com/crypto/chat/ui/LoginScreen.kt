...
import com.crypto.chat.MainActivity
import com.crypto.chat.navigation.Screen
import com.crypto.chat.ui.theme.ChatTheme
...
data class Credentials(
    ...
    fun isValid(): Boolean {
        ...
        val hasNumbers = pwd.any { it.isDigit() }
        val hasSpecialChar = pwd.any { it.isSpecialChar() }
        val isOfValidLength = pwd.length >= 9

        return hasUpperCase && hasLowerCase && hasNumbers && hasSpecialChar && isOfValidLength
    }
}
